...
export const headerTypes = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'iseven', value: 'isEven', regex: '' },
      { id: 'isodd', value: 'isOdd', regex: '' },
      { id: 'isnegative', value: 'isNegative', regex: '' },
      { id: 'iszero', value: 'isZero', regex: '' },
      { id: 'isnotzero', value: 'isNotZero', regex: '' },
      { id: 'ismultipleof', value: 'isAMultipleOf', regex: '' },
      { id: 'isnotmultipleof', value: 'isNotAMultipleOf', regex: '' },
    ],
  },
  {
    id: 5,
