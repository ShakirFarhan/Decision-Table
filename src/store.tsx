...
export const useStore = create<zustandStoreInterface>()(
  devtools((set, get, api) => ({
    ...
    //     const previousColDefs = state.past[state.past.length - 1];
    //     const newPast = state.past.slice(0, state.past.length - 1);
    //     return {
    //       colDefs: previousColDefs,
    //       past: newPast,
    //       future: [...state.future, state.colDefs],
    //     };
    //   });
    // },
    // redo: () => {
    ...
    //     const nextColDefs = state.future[state.future.length - 1];
    //     const newFuture = state.future.slice(0, state.future.length - 1);
    //     return {
    //       colDefs: nextColDefs,
    //       past: [...state.past, state.colDefs],
    //       future: newFuture,
    //     };
    //   });
    // },
